...
<div class="cart-container">
    ...
    <div class="cart-right">
        <div class="summary-card">
            ...
            <button class="btn-buy" style="width: 100%;" onclick="window.location.href='/checkout?role={{ $role ?? 'member' }}'">Buat Pesanan</button>
        </div>
    </div>
</div>
            ...
            grouped[store].forEach(item => {
                ...
                <div class="cart-item" data-id="${item.id}">
                    ...
                    <div class="cart-item-details">
                        <a href="/product/detail?id=${item.id}&role={{ $role ?? 'member' }}" class="cart-item-name">${item.name}</a>
