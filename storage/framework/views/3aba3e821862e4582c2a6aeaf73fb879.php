        ...
        <div class="bento-product-grid">
            ...
            <div class="bento-card bento-gallery product-gallery">
                <div class="main-image-container">
                    <img id="mainImage" src="<?php echo e(asset('assets/hp.png')); ?>" alt="Product Image">
            ...
            <div class="bento-card bento-info product-info">
                <h1 class="product-title">App Oscar Produk Unggulan 100% Original</h1>
                ...
                <div class="price-section">
                    ...
                    <div class="price-original">Rp 798.000</div>
                </div>

                <div class="product-variants">
                    <div class="variant-title">Pilih Varian Aroma:</div>
                    <div class="variant-options">
                        <button class="variant-btn active">Urban (Hijau)</button>
                        <button class="variant-btn">Ocean (Biru)</button>
                        <button class="variant-btn">Woody (Coklat)</button>
                    </div>
                </div>

                <div class="product-description">
                    <div class="desc-tabs">
                        <div class="desc-tab active">Detail Produk</div>
                        <div class="desc-tab">Spesifikasi</div>
                        <div class="desc-tab">Info Penting</div>
                    </div>
            ...
            <div class="bento-card bento-checkout checkout-box">
                ...
                <div style="display: flex; align-items: center;">
                    <div class="qty-selector">
                        ...
                        <input type="number" class="qty-input" id="qtyInput" value="1" min="1" max="50">
                        <button class="qty-btn" onclick="updateQty(1)">+</button>
                    </div>
                    <div class="checkout-stock">
                        Stok <span class="stock-highlight">Sisa 24</span>
                    </div>
                </div>
                
                <div class="subtotal-row">
                    <span class="subtotal-label">Subtotal</span>
                    <span class="subtotal-value" id="subtotalValue">Rp 399.000</span>
                </div>

                <div class="action-buttons">
                    <button class="btn-buy">+ Keranjang</button>
                    <button class="btn-cart">Beli Langsung</button>
                </div>
                ...
                <div class="store-info">
                    ...
                    <div class="store-details">
                        ...
                        <p>Online 5 menit lalu &bull; Jakarta Barat</p>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    function updateQty(change) {
        ...
        if (newVal > 24) newVal = 24; // Max stock
        input.value = newVal;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\0.PROJEK APPS !!!\OSCARAPP\resources\views/product_detail.blade.php ENDPATH**/ ?>