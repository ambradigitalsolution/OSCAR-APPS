...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="nav-group">
            <a href="/orders?role=<?php echo e($role); ?>" class="nav-item" style="color: var(--tk-text-secondary);">
    ...
    <div class="main-content">
        ...
        <div class="content-scroll">
            <div class="breadcrumb">
                <a href="/orders?role=<?php echo e($role); ?>">Seller Center</a>
                <span>&rsaquo;</span>
                <a href="/orders?role=<?php echo e($role); ?>">Pengajuan</a>
                <span>&rsaquo;</span>
                <span>Detail</span>
            </div>
            ...
            <div class="page-header">
                <div>
                    <h1 class="page-title">Detail Pengajuan: <?php echo e($order->order_id); ?></h1>
                    <div class="order-meta">
                        ...
                        <span>Dibuat pada <?php echo e($order->created_at->format('d M Y, H:i')); ?></span>
                    </div>
                </div>
                <div style="display:flex; gap:12px;">
                    <a href="/orders?role=<?php echo e($role); ?>" class="btn btn-outline">Kembali</a>
                    
                    <?php if($role == 'owner'): ?>
                    <form action="/orders/<?php echo e($order->id); ?>/status" method="POST" style="display:flex; gap:8px;">
                        <?php echo csrf_field(); ?>
                        <?php
                        ...
                        ?>
                        <select name="status" class="option-select <?php echo e($badgeClass); ?>" style="padding:10px 14px; border:1px solid transparent; border-radius:8px; font-family:inherit; outline:none; font-weight:700; cursor:pointer;" onchange="updateSelectColor(this)">
                            <?php $__currentLoopData = $statusOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                ...
                                ?>
                                <?php if($show): ?>
                                    <option value="<?php echo e($val); ?>" class="<?php echo e($class); ?>" <?php echo e($order->status == $val ? 'selected' : ''); ?>><?php echo e($val); ?></option>
                                <?php endif; ?>
            ...
            <div class="detail-grid">
                ...
                <div class="items-column">
                    <div class="card">
                        <h2 class="card-title">Daftar Barang (<?php echo e($order->items->sum('qty')); ?> item)</h2>
                                ...
                                <tr>
                                    <td>
                                        <div class="product-cell">
                                            <img src="<?php echo e($item->image_url ?? 'https://via.placeholder.com/60'); ?>" class="product-img" alt="Produk">
                                            <div>
                                                <div class="product-name"><?php echo e($item->product_name); ?></div>
                                                <div class="product-store">Toko: <?php echo e($item->store ?? 'Mitra B2B'); ?></div>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div style="font-size:1.1rem; font-weight:700;"><?php echo e($item->qty); ?> x</div>
                                    </td>
                                </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tbody>
                ...
                <div class="info-column">
                    <div class="card">
                        ...
                        <div class="info-row">
                            ...
                            <div class="info-value"><?php echo e($order->buyer_name); ?></div>
                        </div>
                        
                        <div class="info-row">
                            <div class="info-label">Lokasi / Kota</div>
                            <div class="info-value"><?php echo e($order->buyer_city); ?></div>
                        </div>
...
<?php /**PATH C:\OSCARAPP\resources\views/order_detail.blade.php ENDPATH**/ ?>