...
<section class="products-section section-padding">
    <div class="section-container">
        <div class="section-header">
            ...
            <?php $__currentLoopData = collect($products)->take(12); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="card-item" onclick="window.location.href='/product/detail?id=<?php echo e($product['id'] ?? 1); ?>&role=<?php echo e($role); ?>'" style="border: 1px solid #e2e8f0; border-radius: 8px; background: white; transition: box-shadow 0.2s; position: relative; display: flex; flex-direction: column; overflow: hidden; font-family: 'Inter', sans-serif; cursor: pointer;" onmouseover="this.style.boxShadow='0 4px 12px rgba(0,0,0,0.1)'" onmouseout="this.style.boxShadow='none'">
                ...
                <div style="position: relative; aspect-ratio: 1/1; background-color: #f8fafc; display: flex; align-items: center; justify-content: center; overflow: hidden; padding: 10px;">
                    ...
                    <img src="<?php echo e(asset($product['image'])); ?>" alt="Product" style="max-width: 100%; max-height: 100%; object-fit: contain;">
                </div>
    ...
    <div class="section-container">
        <div class="section-header" style="margin-bottom: 30px;">
            <h2 class="section-title">Semua Produk</h2>
                        ...
                        <div class="expandable-grid product-grid">
            <?php $__currentLoopData = collect($products)->take(36); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="card-item" onclick="window.location.href='/product/detail?id=<?php echo e($product['id'] ?? 1); ?>&role=<?php echo e($role); ?>'" style="border: 1px solid #e2e8f0; border-radius: 8px; background: white; transition: box-shadow 0.2s; position: relative; display: flex; flex-direction: column; overflow: hidden; font-family: 'Inter', sans-serif; cursor: pointer;" onmouseover="this.style.boxShadow='0 4px 12px rgba(0,0,0,0.1)'" onmouseout="this.style.boxShadow='none'">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (addedProducts.length > 0) {
        ...
        [...addedProducts].reverse().forEach(prod => {
            const cardHTML = `
            <div class="card-item" onclick="window.location.href='/product/detail?id=${prod.id}&role=<?php echo e($role); ?>'" style="border: 1px solid #e2e8f0; border-radius: 8px; background: white; transition: box-shadow 0.2s; position: relative; display: flex; flex-direction: column; overflow: hidden; font-family: 'Inter', sans-serif; cursor: pointer;" onmouseover="this.style.boxShadow='0 4px 12px rgba(0,0,0,0.1)'" onmouseout="this.style.boxShadow='none'">
                <div style="position: relative; aspect-ratio: 1/1; background-color: #f8fafc; display: flex; align-items: center; justify-content: center; overflow: hidden; padding: 10px;">
                    <div style="position: absolute; top: 0; right: 0; background-color: #0ea5e9; color: white; font-weight: 700; font-size: 0.7rem; padding: 4px 8px; border-bottom-left-radius: 8px; z-index: 2;">BARU</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\OSCARAPP\resources\views/home.blade.php ENDPATH**/ ?>