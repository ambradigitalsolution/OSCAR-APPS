            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="photo-box">
                            <img src="<?php echo e(asset('assets/server.png')); ?>" alt="Preview">
                        </div>
                    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-hint" style="margin-bottom:12px;">Format gambar .png transparan. Disarankan ukuran 800 x 600px.</div>
                        <div class="photo-box">
                            <img src="<?php echo e(asset('assets/pc.png')); ?>" alt="Preview" style="background:#bbf7d0;">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="photo-box" style="height: 150px;">
                            <img src="<?php echo e(asset('assets/laptop.png')); ?>" alt="Preview" style="background:#e0f2fe; object-position: right bottom;">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-hint" style="margin-bottom:12px;">Format gambar .png transparan. Disarankan ukuran 400 x 300px.</div>
                        <div class="photo-box" style="height: 150px;">
                            <img src="<?php echo e(asset('assets/infokus.png')); ?>" alt="Preview" style="background:#0f172a; object-position: right bottom;">
                        </div>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\OSCARAPP\resources\views/banner_settings.blade.php ENDPATH**/ ?>