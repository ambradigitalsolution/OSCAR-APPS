...
<div class="layout">
    ...
    <aside class="sidebar">
        ...
        <a href="/orders?role=<?php echo e($role); ?>" class="sb-item">
    ...
    <main class="main">
        ...
        <div class="pg-head">
            ...
            <div class="pg-row">
                ...
                <div class="pg-actions">
                    <?php if($role == 'owner'): ?>
                    <a href="/product/form?role=<?php echo e($role); ?>" class="btn btn-teal">
        ...
        <div class="tbl-box">
            ...
            <div class="tbl-tabs" id="status-tabs">
                ...
                <div class="tbl-tab" data-target="aktif">Aktif <span class="cnt"><?php echo e(collect($products)->where('status','Aktif')->count()); ?></span></div>
                <div class="tbl-tab" data-target="nonaktif">Nonaktif <span class="cnt"><?php echo e(collect($products)->where('status','Nonaktif')->count()); ?></span></div>
            </div>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr class="product-row" data-status="<?php echo e(strtolower($product['status'] ?? '')); ?>" data-search="<?php echo e(strtolower($product['name'] . ' ' . ($product['sku'] ?? ''))); ?>">
                        ...
                        <td>
                            <div class="act-cell">
                                <?php if($role == 'owner'): ?>
                                <a href="/product/form?role=<?php echo e($role); ?>" class="act-link">Ubah</a>
                                <?php else: ?>
            ...
            <div class="mobile-cards">
                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="m-card product-row" data-status="<?php echo e(strtolower($product['status'] ?? '')); ?>" data-search="<?php echo e(strtolower($product['name'] . ' ' . ($product['sku'] ?? ''))); ?>">
                    <div class="m-card-top">
                        ...
                        <div class="m-card-info">
                            ...
                            <div class="m-card-sku"><?php echo e($product['warehouse']); ?></div>
                        </div>
                    </div>
                    ...
                    <div class="m-card-footer">
                        ...
                        <div class="act-cell">
                            <?php if($role == 'owner'): ?>
                            <a href="/product/form?role=<?php echo e($role); ?>" class="act-link" style="font-size:13px;">Ubah</a>
                            <?php else: ?>
                            <span style="font-size:12px;color:var(--tk-text-third);">Lihat</span>
                            <?php endif; ?>
                            <?php if($role == 'owner'): ?>
...
<?php /**PATH C:\OSCARAPP\resources\views/seller.blade.php ENDPATH**/ ?>