<header class="main-header">
    <div class="header-container">
        <!-- Logo -->
        <a href="/dashboard?role=<?php echo e(request()->query('role', 'member')); ?>" class="logo">
        ...
        <div class="header-actions">
            <!-- Cart Icon -->
            <a href="/cart?role=<?php echo e(request()->query('role', 'member')); ?>" class="cart-btn">
            ...
            <div style="display: flex; align-items: center; gap: 12px;">
                ...
                <?php if(strtolower(request()->query('role', 'Member')) !== 'owner'): ?>
                <a href="/member/prospek?role=<?php echo e(request()->query('role', 'Member')); ?>" title="Riwayat Prospek" style="display: flex; align-items: center; justify-content: center; width: 36px; height: 36px; border-radius: 50%; background: #f1f5f9; color: #475569; text-decoration: none; transition: background 0.2s; margin-right: 4px;">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" width="18" height="18">
...
<?php /**PATH C:\OSCARAPP\resources\views/partials/header.blade.php ENDPATH**/ ?>