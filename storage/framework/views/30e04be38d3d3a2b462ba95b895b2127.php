...
<div class="layout">
    ...
    <aside class="sidebar">
        ...
        <a href="/orders?role=<?php echo e($role); ?>" class="sb-item active">
        ...
        <div class="sb-sub open">
            <a href="/seller?role=<?php echo e($role); ?>">Kelola produk</a>
            <?php if($role == 'owner'): ?>
            <a href="/product/form?role=<?php echo e($role); ?>">Tambahkan produk</a>
            <a href="/settings/banner?role=<?php echo e($role); ?>">Pengaturan banner</a>
            <a href="/settings/category?role=<?php echo e($role); ?>">Pengaturan kategori</a>
            <?php endif; ?>
        </div>
    </aside>
    ...
    <main class="main">
        ...
        <div class="pg-head">
            <div class="breadcrumb">
                <a href="/seller?role=<?php echo e($role); ?>">Seller Center</a>
        ...
        <div class="stat-grid">
            <div class="stat-card highlight">
                ...
                <div class="stat-value"><?php echo e($stats['pengajuan_baru']); ?></div>
                <div class="stat-sub">Perlu dikonfirmasi</div>
            </div>
            <div class="stat-card">
                <div class="stat-label">Dikonfirmasi</div>
                <div class="stat-value"><?php echo e($stats['dikonfirmasi']); ?></div>
                <div class="stat-sub">Negosiasi harga selesai</div>
            </div>
            <div class="stat-card">
                <div class="stat-label">Dalam Pengiriman</div>
                <div class="stat-value"><?php echo e($stats['dalam_kirim']); ?></div>
        ...
        <div class="tbl-box">
            ...
            <div class="tbl-tabs" id="status-tabs">
                <div class="tbl-tab active" data-target="semua">Semua <span class="cnt"><?php echo e(count($orders)); ?></span></div>
                <div class="tbl-tab" data-target="pengajuan baru">Pengajuan Baru <span class="cnt"><?php echo e(collect($orders)->where('status','Pengajuan Baru')->count()); ?></span></div>
                <div class="tbl-tab" data-target="dikonfirmasi">Dikonfirmasi <span class="cnt"><?php echo e(collect($orders)->where('status','Dikonfirmasi')->count()); ?></span></div>
                <div class="tbl-tab" data-target="dalam pengiriman">Dalam Pengiriman <span class="cnt"><?php echo e(collect($orders)->where('status','Dalam Pengiriman')->count()); ?></span></div>
                <div class="tbl-tab" data-target="selesai">Selesai <span class="cnt"><?php echo e(collect($orders)->where('status','Selesai')->count()); ?></span></div>
                <div class="tbl-tab" data-target="ditolak">Ditolak <span class="cnt"><?php echo e(collect($orders)->where('status','Ditolak')->count()); ?></span></div>
            </div>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr class="order-row" data-status="<?php echo e(strtolower($order->status)); ?>" data-search="<?php echo e(strtolower(($order->order_id) . ' ' . ($order->buyer_name))); ?>" data-date="<?php echo e($order->created_at->format('Y-m-d')); ?>">
                        <td><a href="#" class="order-id"><?php echo e($order->order_id); ?></a></td>
                        <td>
                            <div class="buyer-cell">
                                <div class="buyer-avatar"><?php echo e(strtoupper(substr($order->buyer_name, 0, 1))); ?></div>
                                <div class="td-stack">
                                    <div class="td-val"><?php echo e($order->buyer_name); ?></div>
                                    <div class="td-sub"><?php echo e($order->buyer_city); ?></div>
                                </div>
                            </div>
                        </td>
                        <td>
                            <div class="td-stack">
                                <div class="td-val"><?php echo e($order->items->first()->product_name ?? 'Produk'); ?></div>
                                <div class="td-sub"><?php echo e($order->items->count() > 1 ? '+ ' . ($order->items->count() - 1) . ' barang lain' : ''); ?></div>
                            </div>
                        </td>
                        <td><div class="td-val"><?php echo e($order->items->sum('qty')); ?></div></td>
                        <td>
                            <?php
                        ...
                        <td><div class="td-sub"><?php echo e($order->created_at->format('d/m/Y')); ?></div></td>
                        <td>
                            <div class="act-cell">
                                <?php if($role == 'owner'): ?>
                                <a href="/orders/<?php echo e($order->id); ?>?role=<?php echo e($role); ?>" class="act-link">Detail</a>
                                <?php else: ?>
            ...
            <div class="mobile-cards">
                <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="m-card order-row" data-status="<?php echo e(strtolower($order->status)); ?>" data-search="<?php echo e(strtolower(($order->order_id) . ' ' . ($order->buyer_name))); ?>" data-date="<?php echo e($order->created_at->format('Y-m-d')); ?>">
                    <div class="m-card-header">
                        <a href="#" class="order-id"><?php echo e($order->order_id); ?></a>
                        <?php
                            $badgeClass = match($order->status) {
                                'Pengajuan Baru' => 'badge-new',
                                'Dikonfirmasi' => 'badge-process',
                    ...
                    <div class="m-card-grid">
                        <div class="m-card-stat">
                            ...
                            <div class="value"><?php echo e($order->buyer_name); ?></div>
                        </div>
                        <div class="m-card-stat">
                            <div class="label">Jumlah</div>
                            <div class="value"><?php echo e($order->items->sum('qty')); ?> barang</div>
                        </div>
                        <div class="m-card-stat">
                            <div class="label">Produk</div>
                            <div class="value"><?php echo e($order->items->first()->product_name ?? 'Produk'); ?></div>
                        </div>
                        <div class="m-card-stat">
                            <div class="label">Tanggal</div>
                            <div class="value"><?php echo e($order->created_at->format('d/m/Y')); ?></div>
                        </div>
                    </div>
                    <div class="m-card-footer">
                        <div class="td-sub"><?php echo e($order->buyer_city); ?></div>
                        <?php if($role == 'owner'): ?>
                        <a href="/orders/<?php echo e($order->id); ?>?role=<?php echo e($role); ?>" class="act-link" style="font-size:13px;">Detail</a>
                        <?php else: ?>
                        <span style="font-size:12px;color:var(--tk-text-third);">Lihat</span>
                        <?php endif; ?>
                    </div>
            ...
            <div class="tbl-footer">
                <div class="tbl-footer-left">Total pengajuan: <strong><?php echo e(count($orders)); ?></strong></div>
...
<?php /**PATH C:\OSCARAPP\resources\views/orders.blade.php ENDPATH**/ ?>